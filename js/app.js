 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
                ...
                if (document.querySelector(selector)) {
                    ...
                    const observer = new MutationObserver((mutations => {
                        mutations.forEach((mutation => {
                            if (mutation.type === "attributes" && mutation.attributeName === "class") if (htmlElement.classList.contains("menu-open")) {
                                if (swiperInstance.autoplay && typeof swiperInstance.autoplay.stop === "function") swiperInstance.autoplay.stop();
                            } else if (swiperInstance.autoplay && typeof swiperInstance.autoplay.start === "function") swiperInstance.autoplay.start();
                        }));
                    }));
            ...
            const thumbSwiper = new swiper_core_Swiper(".product-info-intro__thumbs", {
                spaceBetween: 5,
                slidesPerView: 3,
                breakpoints: {
                    768: {
            ...
            const infoProductSwiper = new swiper_core_Swiper(".product-info-intro__slider", {
                ...commonOptions,
                ...
                navigation: {
                    prevEl: ".product-info-intro__slider .swiper-button-prev",
                    nextEl: ".product-info-intro__slider .swiper-button-next"
                },
                thumbs: {
                    swiper: thumbSwiper,
                    autoScrollOffset: 1
            ...
            const thumbSwiperElement = document.querySelector(".product-info-intro__thumbs");
            if (thumbSwiperElement) {
                thumbSwiperElement.addEventListener("mouseenter", (() => {
                    if (infoProductSwiper.autoplay && typeof infoProductSwiper.autoplay.stop === "function") infoProductSwiper.autoplay.stop();
                }));
                thumbSwiperElement.addEventListener("mouseleave", (() => {
                    if (infoProductSwiper.autoplay && typeof infoProductSwiper.autoplay.start === "function") infoProductSwiper.autoplay.start();
                }));
            }
